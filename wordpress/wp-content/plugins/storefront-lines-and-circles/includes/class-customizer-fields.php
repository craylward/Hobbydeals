 ...
 */
final class Storefront_Lines_And_Circles_Customizer_Fields extends Storefront_Lines_And_Circles_Abstract {
	/**
	 ...
	 * @global array $storefront_lines_and_circles_customizer_fields
	 */
	public function sflnc_customize_register( $wp_customize ) {
		global $storefront_lines_and_circles_customizer_fields;

		foreach ( $storefront_lines_and_circles_customizer_fields as $f ) {
